...
public class LunarCalendarOld {
	 ...
	 * 构造一个表示指定日期的农历日历
	 */
	public LunarCalendarOld(Date date) {
	 ...
	 * @param cal
	 */
	public LunarCalendarOld(Calendar cal) {
	...
	public String toLongDateString() {
		...
		String s = dateFm.format(new Date()) + "  ";
		s += getWeekOfDate() + "  ";
		s += (leap ? "闰" : "") + chineseNumber[month - 1] + "月"
				+ getChinaDayString(day);
		return s;
	}
}